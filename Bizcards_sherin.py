...
if selected == "Home":
    ...
    with col1:
        ...
        st.markdown("## :orange[**Overview :**] In this streamlit web app you can upload an image of a business card and extract relevant information from it using easyOCR. You can view, modify or delete the extracted data in this app. This app would also allow users to save the extracted information into a database along with the uploaded business card image. The database would be able to store multiple entries, each with its own business card image and extracted information.")
    with col2:
        st.image("https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTPUzetDyKb24Tc8zoCMDb42LFLGerqaR5NNdykfB6rWI8V9tHtg9ZSoCxv4jz95xhTDMo&usqp=CAU")
        st.image("https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRbo-ZGKKI2_vFbn-LgrxOGO2fOE9y8R6h2Jw&usqp=CAU")
        st.image("https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQ3JJ3kswF5W0MfopK3t3x_9j85KiMK1m8Daw&usqp=CAU")
